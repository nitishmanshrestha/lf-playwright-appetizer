...
if (!fs.existsSync(captureFile)) {
  ...
  console.warn("Looking for a generic capture.json in current dir...");
...
console.log(`Running scaffold-runner for ${moduleName}/${featureName} (capture: ${captureFile})`);
const runner = path.join(__dirname, "..", "scaffold-runner.js");
const args = ["--module", moduleName, "--feature", featureName, "--capture", captureFile];
